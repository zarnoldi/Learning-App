...
// Create Audio Player component for Words and letters?? - G

// Create the Store to store the letter objects (name: string, audio: mp3 file)

// Create Word Game Component
